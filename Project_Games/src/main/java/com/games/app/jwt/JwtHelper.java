...
public class JwtHelper {
    ...
    public JwtHelper(@Value("${accessTokenSecret}") String accessTokenSecret, @Value("${refreshTokenSecret}") String refreshTokenSecret, @Value("${com.games.app.refreshTokenExpirationDays}") int refreshTokenExpirationDays, @Value("${com.games.app.accessTokenExpirationMinutes}") int accessTokenExpirationMinutes) {
